...
class TemporalAwareHead(BaseModule):
    def __init__(self,
                input_size_list, 
                input_dim, 
                hidden_dim, 
    ...
    def forward(self, mlvl_feats):
        ...
        for i, gru in enumerate(self.gru_list):
            input_tensor = mlvl_feats[i]  # [batch_size, time_steps, channels, height, width]
            layer_output_list, last_state_list = gru(input_tensor) 
            
            outputs.append(last_state_list[0])
