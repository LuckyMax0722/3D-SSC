...
class Decoder(nn.Module):
    ...
    def __init__(self, latent_dim):
        ...
        self.Image_decoder_block1 = nn.Sequential(  
            nn.Conv2d(4 + latent_dim, 3, kernel_size=3, padding=1, stride=1),
            nn.ReLU(),
    ...
    def forward_image(self, x, depth, z):
        ...
        x = torch.cat((x, depth, z), 1)  # torch.Size([5, 7, 370, 1220])
        
        x = self.Image_decoder_block1(x)

        
        return x.unsqueeze(0) # torch.Size([1, 5, 7, 370, 1220])
