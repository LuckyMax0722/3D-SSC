...
from .utils import Conv1d, PointNet_FP_Module, PointNet_SA_Module, Transformer
...
class PointsEncoder_pointwise(nn.Module):
    def __init__(self, is_pc_norm):
        ...
        if is_pc_norm:
            self.sa_module_1 = PointNet_SA_Module(1024, 64, 0.2, 3, [64, 64, 128], group_all=False) # radius x 100 0.2->20
            self.transformer_start_1 = Transformer(128, dim=64)
            ...
            self.sa_module_1 = PointNet_SA_Module(1024, 64, 20, 3, [64, 64, 128], group_all=False) # radius x 100 0.2->20
            self.transformer_start_1 = Transformer(128, dim=64)
